...
<header>
    <div class="row mb-4">
        <div class="col-md-3 ml-3">
             <a class="btn btn-danger" href="<?=PROOT?>bookstore/details/<?=$this->book->id?>"><i class="fas fa-backward"></i> Back to Details</a>
        </div>
        <div class="col-md-8">
            <h1 class="offset-3 text-danger font-weight-bold">Create Review</h1>
        </div>
    </div>
</header>
            ...
            <form action="" method="post">
               ...
               <?php for ($i=1; $i<=5; $i++) : ?>  
                ...
                <div class="d-flex justify-content-end">
                    <input type="submit" class="btn btn-danger" value="Submit My Review">
                </div>
            </form>
        </div>
    </div>
